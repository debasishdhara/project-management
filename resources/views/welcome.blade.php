                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="wellcome-text">
                    <div class="well-text text-center">
                      <h2>Welcome To Our Demo Test</h2>
                      <p>
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <div class="single-blog">
                    ...
                    <div class="blog-text">
                      <h4>
                                              <a href="javascript:void(0);">Assumenda repud eum veniam</a>
                                          </h4>
                      <p>
                    ...
                    <span>
                                          <a href="javascript:void(0);" class="ready-btn">Read more</a>
                                      </span>
                  </div>
                  <!-- Start single blog -->
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <div class="single-blog">
                    ...
                    <div class="blog-text">
                      <h4>
                                              <a href="javascript:void(0);">Explicabo magnam quibusdam.</a>
                                          </h4>
                      <p>
                        Lorem ipsum dolor sit amet conse adipis elit Assumenda repud eum veniam optio modi sit explicabo nisi magnam quibusdam.sit amet conse adipis elit Assumenda repud eum veniam optio modi sit explicabo nisi magnam quibusdam.
                      </p>
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs=12">
                <div class="suscribe-text text-center">
                  <h3>Welcome to our Demo Test company</h3>
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="copyright text-center">
                    <p>
                      &copy; Copyright <strong>Demo Test</strong>. All Rights Reserved
                    </p>
                  </div>
                </div>
              </div>
