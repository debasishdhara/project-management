    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <hr>
                {!! Form::open(['route'=>['add-states']]) !!}
                <div class="form-group row">
                 <label for="input-26" class="col-sm-2 col-form-label">State Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control {{ $errors->has('state_title') ? 'is-invalid' : '' }}" name="state_title" value="{{ old('state_title') }}" required>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                    <input type="checkbox" id="toggle-two" name="state_status" @if(old('state_status')) checked @endif data-onstyle="success" data-offstyle="danger">
