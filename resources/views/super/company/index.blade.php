...
<div class="row col">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header"><span class="card-title"><i class="fa fa-table"></i> All Companies Details</span> <div class="pull-right"><a class="btn btn-primary" href="{{route('add-company')}}">Add Company</a></div></div>
      <div class="card-body">
