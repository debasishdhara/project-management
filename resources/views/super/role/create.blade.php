            ...
            <div class="card">
                ...
                <div class="form-group row">
                 <label for="input-26" class="col-sm-2 col-form-label">Role Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control {{ $errors->has('role_name') ? 'is-invalid' : '' }}" name="role_name" value="{{ old('role_name') }}" required>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                    <input type="checkbox" id="toggle-two" name="role_status" @if(old('role_status')) checked @endif data-onstyle="success" data-offstyle="danger">
