...
<!--Start Dashboard Content-->
     ...
     <div class="row mt-3">
       <div class="col-12 col-lg-6 col-xl-3">
         <div class="card">
           <div class="card-body">
              ...
              <p class="mb-0 small-font">Total Company 
       ...
       <div class="col-12 col-lg-6 col-xl-3">
         <div class="card">
           <div class="card-body">
              ...
              <p class="mb-0 small-font">Total User 
       ...
       <div class="col-12 col-lg-6 col-xl-3">
         <div class="card">
            <div class="card-body">
              <h5 class="mb-0">0 <span class="float-right"><i class="fa fa-archive"></i></span></h5>
                <div class="progress my-3" style="height:3px;">
                   <div class="progress-bar gradient-ohhappiness" style="width:0%"></div>
                </div>
              <p class="mb-0 small-font">Projects 
       ...
       <div class="col-12 col-lg-6 col-xl-3">
         <div class="card">
            <div class="card-body">
              <h5 class="mb-0">0 <span class="float-right"><i class="fa fa-tasks"></i></span></h5>
                <div class="progress my-3" style="height:3px;">
                   <div class="progress-bar gradient-ibiza" style="width:0%"></div>
                </div>
              <p class="mb-0 small-font">Tasks 
         ...
         <div class="card">
           ...
           <ul class="list-group list-group-flush">
              <li class="list-group-item">
                <div class="media align-items-center">
                  <img src="{{asset('theme/assets/images/110x110_sq.png')}}" alt="user avatar" class="customer-img rounded-circle">
                <div class="media-body ml-3">
	   ...
	   <div class="card">
	     <div class="card-header border-0">Recent Order Tables
		  <div class="card-action">
           ...
           <tbody><tr>
                    <td>
                      <img alt="Image placeholder" src="{{asset('theme/assets/images/110x110_sq.png')}}" class="product-img">
                    </td>
          <td>Headphone GL</td>
                    <td>$1,840 USD</td>
                    <td>
