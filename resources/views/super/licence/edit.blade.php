...
<!-- Breadcrumb-->
     <div class="row pt-2 pb-2">
        <div class="col-sm">
		    <h4 class="page-title">Edit Licence</h4>
		    <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Licence</li>
         </ol>
	   </div>
     </div>
    <!-- End Breadcrumb-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <hr>
                {!! Form::open(['route'=>['edit-licences',$licence_details->id]]) !!}
                <div class="form-group row">
                 <label for="licence_name" class="col-sm-2 col-form-label">Licence Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control {{ $errors->has('licence_name') ? 'is-invalid' : '' }}" name="licence_name" value="{{ old('licence_name',$licence_details->licence_name) }}" required>
                ...
                <div class="form-group row">
                  <label for="licence_description" class="col-sm-2 col-form-label">Licence Desciption</label>
                   <div class="col-sm-10">
                     <textarea class="form-control {{ $errors->has('licence_description') ? 'is-invalid' : '' }}" name="licence_description" id="licence_description" required>
                      {{ old('licence_description',$licence_details->licence_description) }}
                     </textarea>
                 ...
                 <div class="form-group row">
                  <label for="licence_amount" class="col-sm-2 col-form-label">Amount</label>
                   <div class="col-sm-10">
                     <input type="number" min="0" class="form-control {{ $errors->has('licence_amount') ? 'is-invalid' : '' }}" name="licence_amount" value="{{ old('licence_amount',$licence_details->licence_amount) }}" onchange="amount_settings();" required>
                 ...
                 <div class="form-group row">
                  <label for="licence_discount" class="col-sm-2 col-form-label">Discount (%)</label>
                   <div class="col-sm-10">
                     <input type="number" min="0" max="100" class="form-control" name="licence_discount" value="{{ old('licence_discount',$licence_details->licence_discount) }}"  onchange="amount_settings();" >
                   </div>
                 </div>
                 <div class="form-group row">
                  <label for="licence_total" class="col-sm-2 col-form-label">Total Amount</label>
                   <div class="col-sm-10">
                     <input type="number" min="0" class="form-control" name="licence_total" value="{{ old('licence_total',$licence_details->licence_total) }}"  onchange="amount_settings();" readonly>
                   </div>
                 </div>
                 <div class="form-group row">
                  <label for="licence_tax" class="col-sm-2 col-form-label">Tax (%)</label>
                   <div class="col-sm-10">
                     <input type="number" min="0" max="100" class="form-control" name="licence_tax"  onchange="amount_settings();" value="{{ old('licence_tax',$licence_details->licence_tax) }}">
                   </div>
                 </div>
                 <div class="form-group row">
                  <label for="licence_taxableamount" class="col-sm-2 col-form-label">Total Amount with Tax</label>
                   <div class="col-sm-10">
                     <input type="number" min="0" class="form-control" name="licence_taxableamount"  onchange="amount_settings();" value="{{ old('licence_taxableamount',$licence_details->licence_taxableamount) }}" readonly>
                   </div>
                 </div>
                 <div class="form-group row">
                  <label for="licence_net_amount" class="col-sm-2 col-form-label">Payment Amount</label>
                   <div class="col-sm-10">
                     <input type="number" min="0" class="form-control" name="licence_net_amount"  onchange="amount_settings();" value="{{ old('licence_net_amount',$licence_details->licence_net_amount) }}" readonly>
                   </div>
                 </div>
                 <div class="form-group row">
                  <label for="licence_validity" class="col-sm-2 col-form-label">Validity <span class="small">(How many days !!!)</span></label>
                   <div class="col-sm-10">
                     <input type="number" min="0" class="form-control {{ $errors->has('licence_validity') ? 'is-invalid' : '' }}" name="licence_validity" value="{{ old('licence_validity',$licence_details->licence_validity) }}" required>
                 ...
                 <div class="form-group row">
                  <label for="licence_user_limit" class="col-sm-2 col-form-label">User Limit</span></label>
                   <div class="col-sm-10">
                     <input type="number" min="2" class="form-control {{ $errors->has('licence_user_limit') ? 'is-invalid' : '' }}" name="licence_user_limit" value="{{ old('licence_user_limit',$licence_details->licence_user_limit) }}" required>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                    <input type="checkbox" id="toggle-two" name="licence_status" @if(old('licence_status',$licence_details->licence_status)) checked @endif data-onstyle="success" data-offstyle="danger">
                 </div>
               </div>
                <div class="form-group row">
