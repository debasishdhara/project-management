    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <hr>
                {!! Form::open(['route'=>['add-cities']]) !!}
                <div class="form-group row">
                 <label for="input-26" class="col-sm-2 col-form-label">City Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control {{ $errors->has('city_title') ? 'is-invalid' : '' }}" name="city_title" value="{{ old('city_title') }}" required>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                    <input type="checkbox" id="toggle-two" name="city_status" @if(old('city_status')) checked @endif data-onstyle="success" data-offstyle="danger">
