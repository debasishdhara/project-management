    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <hr>
                {!! Form::open(['route'=>['add-sub-cities']]) !!}
                <div class="form-group row">
                 <label for="input-26" class="col-sm-2 col-form-label">SubCity Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control {{ $errors->has('subcity_title') ? 'is-invalid' : '' }}" name="subcity_title" value="{{ old('subcity_title') }}" required>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                    <input type="checkbox" id="toggle-two" name="subcity_status" @if(old('subcity_status')) checked @endif data-onstyle="success" data-offstyle="danger">
